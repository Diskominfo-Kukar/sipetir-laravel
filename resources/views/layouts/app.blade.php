...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/select2-bootstrap-5-theme@1.3.0/dist/select2-bootstrap-5-theme.min.css" />  <link href="{{asset('assets/plugins/jquery-toast-plugin-master/src/jquery.toast.css')}}" rel="stylesheet" />
...
<body>
              ...
              <li class="nav-item dropdown dropdown-large">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li>
                    ...
                    @csrf
                      <a class="dropdown-item" :href="route('logout')" method="post" as="button" onclick="event.preventDefault(); this.closest('form').submit();">
                        <div class="d-flex align-items-center">
                          <div class="setting-icon">
  ...
  <script type="text/javascript" src="{{ asset('assets/plugins/jquery-toast-plugin-master/src/jquery.toast.js')}}"></script>
