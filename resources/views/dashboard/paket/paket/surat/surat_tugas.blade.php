    ...
    <div class="body">
        ...
        <table style="border-collapse: collapse; width: 100%;">
            <tr>
                ...
                <td style="padding: 8px; text-align: justify;">Peraturan Daerah Nomor 9 Tahun 2016 tentang Pembentukan
                    dan Susunan Perangkat Daerah Kabupaten Kutai Kartanegara;</td>
            </tr>
            <tr>
                <td></td>
                <td style="padding: 8px; vertical-align: top;"></td>
                <td style="padding: 8px; vertical-align: top;">2</td>
                <td style="padding: 8px; text-align: justify;">Peraturan Bupati Nomor 2 Tahun 2019 tentang Kedudukan
                    Susunan Organisasi, Tugas dan Fungsi serta Tata Kerja Perangkat Daerah pada Sekretariat Daerah;</td>
            </tr>
            <tr>
                <td></td>
                <td style="padding: 8px; vertical-align: top;"></td>
                <td style="padding: 8px; vertical-align: top;">3</td>
                <td style="padding: 8px; text-align: justify;">Berdasarkan Keputusan Kepala Bagian Pengadaan Barang/Jasa
                    Nomor : P-243/PPBJ/BPBJ/SK-POKMIL/04/2024 Perubahan atas keputusan Kepala Bagian Pengadaan
                    Barang/Jasa Nomor : 655/PNA/BPBJ/SK/04/2023 Tentang Penetapan Pejabat Pengelola Pengadaan
                    Barang/Jasa Kedalam Kelompok Kerja Pemilihan Penyedia Barang/Jasa Pada Bagian Pengadaan Barang dan
                    Jasa Sekretariat Daerah Kabupaten Kutai Kartanegara.</td>
            </tr>
        </table>&nbsp;
...
@endif
            ...
            <tr>
                ...
                <td style="padding: 0 8px; vertical-align: top; width: 5%;">:</td>
                <td style="padding: 0 8px; vertical-align: top; width: 55%;">Rp
                    {{ App\Helpers\Format::rupiah($surat_tugas->pagu) }}</td>
                <td style="padding: 0 8px;"></td>
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                ...
                <td style="padding: 0 8px; vertical-align: top; width: 5%;">:</td>
                <td style="padding: 0 8px; vertical-align: top; width: 55%;">Rp
                    {{ App\Helpers\Format::rupiah($surat_tugas->hps) }}</td>
                <td style="padding: 0 8px;"></td>
            </tr>
            <tr>
                <td style="width: 10%;"></td>
