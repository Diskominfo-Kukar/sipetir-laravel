...
class ImportData extends Command
{
     ...
     * @var string
     */
    protected $description = 'Import Data Sipetir';
    ...
    public function importJabatanMaster()
    {
    ...
    public function importPegawaiMaster()
    {
    ...
    public function importPanitiaPokmil()
    {
    ...
    public function importSumberDana()
    {
